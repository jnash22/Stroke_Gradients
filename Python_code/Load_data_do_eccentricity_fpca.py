...
# Load Data
path_to_yeo = Data_path + 'Sample_data/Yeo_2_NMT_CC_atlas.csv'
Yeo_atlas = pd.read_csv(path_to_yeo)

Salvaged_areas = Data_path + 'Sample_data/Salvaged.csv'
...
#Load Sample Data
Directory_data = Data_path + 'Sample_data/'
...
# ###################################################### Behavioural Analysis #############################################
# ###################################################### Behavioural Analysis #############################################
# Behaviour_path = Data_path + 'Sample_data/NHPSS_test.csv' ###### new behav path
Behaviour_path = Data_path + 'Sample_data/FINAL_NHPSS.csv'
